...
describe('Posts', () => {
    ...
    describe('POST /posts', () => {
        ...
        it('Create a Post - 200', async () => {
            ...
            const res = await api().post(SETTINGS.POSTS).send(validPost.payload);

            console.log('Payload', validPost.payload);
            console.log('URL', SETTINGS.POSTS);
